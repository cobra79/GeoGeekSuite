...
class PgInterface():
    ...
    def get_schemas(self):
        ...
        schemas = self.__execute_sql__('SELECT schema_name FROM information_schema.schemata',fetch='all')
    ...
    def get_tables(self):
        ...
        for a_schema in schemas:
            ...
            result = self.__execute_sql__(sql,fetch='all')
    ...
    def get_geometry_columns(self, schema, table):
        ...
        res = self.__execute_sql__(sql,fetch='all')
